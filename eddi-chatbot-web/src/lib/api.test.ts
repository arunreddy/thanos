...
describe('API functions', () => {
  ...
  describe('sendMessage', () => {
    ...
    //   expect(url).toBe('http://localhost:8000/api/chat/send');
  ...
  //     const [url, options] = mockFetch.mock.calls[0];
  //     expect(url).toBe('http://localhost:8000/api/chat/conversations');
  //     expect(options.headers instanceof Headers).toBe(true);
  //     expect(options.headers.get('Content-Type')).toBe('application/json');
  ...
  //     const [url, options] = mockFetch.mock.calls[0];
  //     expect(url).toBe('http://localhost:8000/api/chat/conversations/1');
  //     expect(options.headers instanceof Headers).toBe(true);
  //     expect(options.headers.get('Content-Type')).toBe('application/json');
